                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select name="building_category" class="mt-1.5 w-full rounded-2xl border border-slate-300 px-4 py-2.5 text-sm bg-white" required>
                                ...
                                <option value="tin_shed" @selected(old('building_category') === 'tin_shed')>টিন শেড</option>
                                <option value="below_or_equal_4_floor" @selected(old('building_category') === 'below_or_equal_4_floor')>৪তলা বা নিচে</option>
                                <option value="above_4_floor" @selected(old('building_category') === 'above_4_floor')>৪তলার উপরে</option>
                                <option value="shop" @selected(old('building_category') === 'shop')>দোকান</option>
                            </select>

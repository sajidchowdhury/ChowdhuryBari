    ...
    <section id="about" class="max-w-7xl mx-auto px-6 pt-20 pb-16">
        <div class="grid lg:grid-cols-12 gap-x-12 items-center">
            <div class="lg:col-span-7">
                ...
                <h2 class="section-header text-5xl lg:text-[56px] leading-none tracking-tighter font-bold heading-serif mb-8">{{ $about->headline }}</h2>

                <div class="max-w-2xl text-[17px] leading-relaxed text-slate-600 whitespace-pre-line">
                    {{ $about->description }}
                </div>
            ...
            <div class="lg:col-span-5 mt-12 lg:mt-0">
                <div class="relative rounded-3xl overflow-hidden shadow-2xl ring-1 ring-slate-900/10">
                    <img src="{{ $about->image_url }}" alt="{{ $about->headline }}" class="w-full aspect-[16/13] object-cover">
